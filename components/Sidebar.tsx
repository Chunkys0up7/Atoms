  ...
  const sections: { title: string; items: { id: ViewType; label: string; icon: string; count?: number }[] }[] = [
    {
      ...
      items: [
        ...
        { id: 'publisher', label: 'Publisher Portal', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
      ]
    },
    {
      title: 'Control & Governance',
      items: [
        { id: 'explorer', label: 'Global Registry', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
        ...
        { id: 'edges', label: 'Dependency Audit', icon: 'M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'ontology', label: 'Enterprise Ontology', icon: 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.477 2.387a2 2 0 00.547 1.022l1.428 1.428a2 2 0 001.022.547l2.387.477a2 2 0 001.96-1.414l.477-2.387a2 2 0 00-.547-1.022l-1.428-1.428z' },
        { id: 'glossary', label: 'Platform Glossary', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
      ]
    }
  ];
    ...
    <aside className="w-64 bg-[#0a0f1d] border-r border-slate-800 flex flex-col h-full shrink-0">
      ...
      <div className="p-6 border-t border-slate-800">
        <div className="bg-slate-900/80 rounded-2xl p-4 border border-slate-800 shadow-sm">
          <p className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-3">System Health</p>
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-2 h-2 rounded-full bg-blue-500"></div>
              <div className="w-2 h-2 rounded-full bg-blue-500 absolute inset-0 animate-ping"></div>
            </div>
            <span className="text-[10px] font-bold text-slate-300">Semantic Engine Ready</span>
          </div>
        </div>
      </div>
    </aside>
