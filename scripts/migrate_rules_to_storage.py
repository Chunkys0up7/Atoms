...
from routes.rules import RuleDefinition, ConditionGroup, ConditionRule, RuleAction, PhaseAction, RuleModification
...
def migrate_rules():
    ...
    rules.append(create_rule_definition(
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Credit score below threshold (620)",
                criticality="HIGH"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Transaction amount exceeds $1M threshold",
    ...
    rules.append(create_rule_definition(
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Compliance requirements detected (AML/KYC)",
                criticality="HIGH"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Risk flags detected requiring fraud investigation",
                criticality="CRITICAL"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        condition=ConditionGroup(
            ...
            rules=[
                ConditionRule(
                    field="customer_data.first_time_borrower",
                    operator="EQUALS",
                    value=True
                )
            ]
    ...
    rules.append(create_rule_definition(
        ...
        condition=ConditionGroup(
            ...
            rules=[
                ConditionRule(
                    field="customer_data.debt_to_income_ratio",
                    operator="GREATER_THAN",
                    value=0.43
                )
            ]
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="DTI ratio exceeds 43% threshold",
                criticality="HIGH"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        condition=ConditionGroup(
            ...
            rules=[
                ConditionRule(
                    field="customer_data.employment_type",
                    operator="EQUALS",
                    value="SELF_EMPLOYED"
                )
            ]
    ...
    rules.append(create_rule_definition(
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Non-standard property type requires enhanced appraisal",
                criticality="MEDIUM"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        condition=ConditionGroup(
            ...
            rules=[
                ConditionRule(
                    field="transaction_data.loan_purpose",
                    operator="EQUALS",
                    value="REFINANCE"
                ),
                ConditionRule(
                    field="transaction_data.cash_out_amount",
                    operator="GREATER_THAN",
                    value=0
                )
            ]
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Cash-out refinance requires equity review",
                criticality="MEDIUM"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        condition=ConditionGroup(
            ...
            rules=[
                ConditionRule(
                    field="transaction_data.property_state",
                    operator="IN",
                    value=["NY", "TX", "CA", "NV"]
                )
            ]
        ...
        action=RuleAction(
            ...
            modification=RuleModification(
                reason="Property in state with special compliance requirements",
                criticality="HIGH"
            )
        )
    ))
    ...
    rules.append(create_rule_definition(
        ...
        condition=ConditionGroup(
            ...
            rules=[
                ConditionRule(
                    field="customer_data.residency_status",
                    operator="EQUALS",
                    value="NON_RESIDENT"
                )
            ]
...
def save_to_storage(rules: list):
    ...
    from routes.rules import save_rules_to_storage, save_rule_yaml_backup
