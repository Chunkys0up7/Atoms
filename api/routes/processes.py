...
try:
    ...
    from ..orchestrator import EventType, ProcessStatus, WorkflowEngine, get_event_bus
except ImportError:
...
def update_process_status(process_id: str, request: UpdateProcessStatusRequest) -> Dict[str, Any]:
    """
...
def suspend_process(process_id: str, user_id: str, reason: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        event_bus.publish(EventType.PROCESS_SUSPENDED, {"process_id": process_id, "reason": reason}, source=user_id)
...
def resume_process(process_id: str, user_id: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        event_bus.publish(EventType.PROCESS_RESUMED, {"process_id": process_id}, source=user_id)
...
def get_process_events(process_id: str, limit: int = Query(100, ge=1, le=500)) -> List[Dict[str, Any]]:
    """
